...
describe('ReactElementClone', () => {
  ...
  it('should override children if undefined is provided as an argument', () => {
    ...
    expect(element2.props.children[0]).toBe(undefined);
  });
  ...
  it('should normalize props with default values', () => {
    ...
    expect(clonedInstance.props.prop).toBe(undefined);
    ...
    //@todo offical is testkey but i think it is undefined
    expect(cloneInstance3.props.prop).toBe(undefined);
  ...
  it('should check declared prop types after clone', () => {
    ...
    renderIntoDocument(React.createElement(GrandParent));

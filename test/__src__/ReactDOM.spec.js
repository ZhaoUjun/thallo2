...
describe('React', () => {
  ...
  //   React.render(<A />, myDiv);
  //   expect(() => React.render(<A />, myDiv, 'no')).toThrowError(
  ...
  //   );
  //   React.render(<A />, myDiv); // Re-mount
  //   expect(() => React.render(<A />, myDiv, {foo: 'bar'})).toThrowError(
  //     'Invalid argument passed as callback. Expected a function. Instead ' +
  ...
  //   );
  //   React.render(<A />, myDiv); // Re-mount
  //   expect(() => React.render(<A />, myDiv, new Foo())).toThrowError(
  //     'Invalid argument passed as callback. Expected a function. Instead ' +
  //       'received: [object Object]',
  //   );

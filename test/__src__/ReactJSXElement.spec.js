...
describe("ReactJSXElement", () => {
    ...
    it("is indistinguishable from a plain object", () => {
        //here not like offical we use Class
    ...
    it("should use default prop value when removing a prop", () => {
        ...
        var instance = React.render(<Component fruit="mango" />, container);
    ...
    it("should normalize props with default values", () => {
        const container = document.createElement("dov");
        ...
        var instance = React.render(<NormalizingComponent />, container);

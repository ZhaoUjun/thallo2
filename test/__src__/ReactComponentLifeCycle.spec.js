...
describe('ReactComponentLifeCycle', () => {
  ...
  it('it should fire onDOMReady when already in onDOMReady', () => {
    ...
    renderIntoDocument(<SwitcherParent />);
  ...
  //   renderIntoDocument(<StatefulComponent />);
  ...
  it('should not throw when updating an auxiliary component', () => {
    ...
    var container = document.createElement('div');
    React.render(<Component text="uno" tooltipText="one" />, container);

    // Since `instance` is a root component, we can set its props. This also
    // makes Tooltip rerender the tooltip component, which shouldn't throw.
    React.render(<Component text="dos" tooltipText="two" />, container);
  });
  ...
  // it('calls effects on module-pattern component', function() {
    ...
    // React.render(<Parent ref={c => c && log.push('ref')} />, div);
    // React.render(<Parent ref={c => c && log.push('ref')} />, div);

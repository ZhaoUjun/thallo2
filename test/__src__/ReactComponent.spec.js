...
describe('ReactComponent', () => {
 ...
 //@todo
  ...
  it('should not have refs on unmounted components', () => {
    ...
    renderIntoDocument(<Parent child={<span />} />);
  });
  ...
  //   var X = undefined;
  //   expect(() => renderIntoDocument(<X />)).toThrowError(
  ...
  //   var Y = null;
  //   expect(() => renderIntoDocument(<Y />)).toThrowError(
  //     'Element type is invalid: expected a string (for built-in components) ' +
  ...
  //   expect(() => renderIntoDocument(<Foo />)).toThrowError(
  //     'Element type is invalid: expected a string (for built-in components) ' +
  //       'or a class/function (for composite components) but got: undefined. ' +
  //       "You likely forgot to export your component from the file it's " +
  ...
  //     }
  //     var container = document.createElement('div');
  //     var component = React.render(<Foo />, container);
